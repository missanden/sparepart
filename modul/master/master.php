...
//Langkah 2: Sesuaikan perintah SQL
			...
			<a href=?module=master&act=editsupplier&id=$data[kode_supplier]><img src='images/edit.png' border='0' title='edit' /></a>
							...
							<td align=left class=cc>Telephone Supplier</td><td><input type='text' name='telpon_supplier'  placeholder='Telephone Supplier' size='30'></td>
                                                        ...
                                                        <tr>
							<td align=left class=cc>Jenis Supplier</td>
                                                        <td>
                                                            <select name='type_supplier'>
...
<center><table border='1' cellspacing='0' cellpadding='0' width='95%'>
	...
	<th width='20%'>Nama Supplier</th>
	<th width='10%'>No. Telephone</th>
        <th width='10%'>Type Supplier</th>
	<th width='50%'>Alamat Supplier</th>
	<th width='5%'>EDIT</th>
	</tr>";
                                        ...
                                        <body>	
                                            ...
                                            <span>
                                                <ul>        
                                                    ...
                                                    <table id='tablemodul'>
                                                        <tr>
                                                            <td align=left class=cc>Nama Part</td>
                                                            <td><input type='text' name='part_name'  placeholder='Nama Part' size='30'></td>
							</tr>
							<tr>
                                                            <td align=left class=cc>Part Number</td>
                                                            <td><input type='text' name='part_number'  placeholder='Part Number' size='30'></td>
							</tr>
							<tr>
                                                            <td align=left class=cc>Part Price</td>
                                                            <td><input type='text' name='part_price'  placeholder='Part Price' size='12'></td>
							</tr>
                                                        <tr>
                                                            <td align=left class=cc>Frequency Replace Part</td>
                                                            <td><select name='part_freq'>
                                                                    <option value=''>- frequency -</option>";
                                                                    for ($count = 1; $count < 13; $count++) {
                                                                        echo "<option value='$count'>$count bulan</option>";
                                                                    }
                                                                    echo "</select></td>
							</tr>
							<tr>
                                                            <td align=left class=cc>Minimum Stock</td><td><input type='text' name='part_limit'  placeholder='Jumlah stok' size='12'></td>
							</tr>
                                                        <tr>
                                                            <td align=left class=cc>Lead Time Order</td>
                                                            <td><input type='text' name='part_leadtimeorder'  placeholder='Jumlah hari' size='12'></td>
							</tr>
							<tr>
                                                            <td align=left class=cc>Location</td>
                                                            <td>
...
//Langkah 2: Sesuaikan perintah SQL
			...
			order by masterpart.part_name asc ";
                                            ...
                                            while ($data = mysql_fetch_array($hasil)) {
                                                ...
                                                if ($data['part_stock'] < $data['part_limit']) {
                                                    ...
                                                    $status = "<font color='green'><b>OKE</b></font>";
                                                }
			...
			order by masterpart.part_name asc ";
							...
							<tr>
                                                            <td align=left class=cc>Nama Part</td>
                                                            <td><input type='text' name='part_name'  placeholder='Nama Part' size='30' value='$data[part_name]'></td>
							</tr>
							<tr>
                                                            <td align=left class=cc>Part Number</td>
                                                            <td><input type='text' name='part_number'  placeholder='Part Number' size='30' value='$data[part_number]'></td>
							</tr>
							<tr>
                                                            <td align=left class=cc>Part Price</td>
                                                            <td><input type='text' name='part_price'  placeholder='Part Price' size='10' value='$data[part_price]'></td>
							</tr>
                                                        <tr>
                                                            <td align=left class=cc>Frequency Replace Part</td>
                                                            <td><select>";
                                                        for ($count = 1; $count < 13; $count++) {
                                                            ...
                                                            echo "<option value='$count' $selected>$count bulan</option>";
                                                        }
                                                        echo "</select></td>
							</tr>
                                                        <tr>
...
<center><table border='1' cellspacing='0' cellpadding='0' width='100%'>
	<tr>
	<th><center>No</th>
	<th>Nama Part</th>
	<th>No. Part</th>
