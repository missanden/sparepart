...
mysql_query("INSERT INTO header_transaksi
	...
	for($i=1; $i<=$nomor; $i++)
			...
			mysql_query("INSERT INTO ocbs_datapenumpang
								(no_transaksi,
								kodeproduct,
                                 qty_transaksi,
                                 price_total_transaksi) 
...
$query1=mysql_query("SELECT * FROM masterpart WHERE kodeproduct='".$_POST['kode_product'][$i]."'");
$data1=mysql_fetch_array($query1);

$part_stock=$data1['part_stock']+$_POST['qty_transaksi'][$i];
